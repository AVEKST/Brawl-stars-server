...
class LobbyInfoMessage(PiranhaMessage):
    ...
    def encode(self, fields, player):
        ...
        self.writeString("Project Sally Brawl t.me/sally_brawl\n"f"Version: {player.ClientVersion}")
        self.writeVInt(0)
    ...
    def getMessageVersion(self):
        return self.messageVersion Classes.ClientsManager self.messageVersion Classes.Packets.PiranhaMessage 